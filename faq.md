...
To move assets into or out of an Optimistic Ethereum network you can use the [**Boba Gateway**](https://gateway.boba.network). We have detailed instructions in our [user documentation](../../boba\_documentation/user/001_how-to-bridge.md). If you are a developer, there are two methods, the **classical bridge** and the **fast bridge**. Please see this [code example](../../boba\_examples/init-fund-l2).
...
Connection details for our Rinkeby network can be found [here](../../boba\_documentation/developer/005\_parameters-rinkeby.md).

Connection details for our mainnet can be found [here](../../boba\_documentation/developer/006\_parameters-mainnet.md).
...
You can check decimals using the [blockexplorer](blockexplorer.boba.network), for example:
