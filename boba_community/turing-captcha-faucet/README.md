...
* `boba_community/turing-captcha-faucet/packages`: Contains all the typescript packages and contracts
  ...
  * `deployment`: Boba faucet Goerli contract addresses
...
NETWORK=goerli
L1_NODE_WEB3_URL=https://goerli.infura.io/v3/9844f35ff4a84003a7025a65a9412002
