...
const BobaGoerliChain: Chain = {
  ...
  getExplorerAddressLink: (address: string) => `https://blockexplorer.goerli.boba.network/address/${address}`,
  getExplorerTransactionLink: (transactionHash: string) => `https://blockexplorer.goerli.boba.network/tx/${transactionHash}`,
}
