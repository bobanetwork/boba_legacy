...
var (
	...
	MinSequencerL1TxSizeFlag = cli.Uint64Flag{
		Name: "min-sequencer-l1-tx-size",
		Usage: "Minimum size in bytes of any L1 transaction that gets " +
			"generated by the sequencer",
		Required: true,
		EnvVar:   prefixEnvVar("MIN_SEQUENCER_L1_TX_SIZE"),
	}
	MaxSequencerL1TxSizeFlag = cli.Uint64Flag{
		Name: "max-sequencer-l1-tx-size",
		Usage: "Maximum size in bytes of any L1 transaction that gets " +
			"generated by the sequencer",
		Required: true,
		EnvVar:   prefixEnvVar("MAX_SEQUENCER_L1_TX_SIZE"),
	}
	MinProposerL1TxSizeFlag = cli.Uint64Flag{
		Name: "min-proposer-l1-tx-size",
		Usage: "Minimum size in bytes of any L1 transaction that gets " +
			"generated by the proposer",
		Required: true,
		EnvVar:   prefixEnvVar("MIN_PROPOSER_L1_TX_SIZE"),
	}
	MaxProposerL1TxSizeFlag = cli.Uint64Flag{
		Name: "max-proposer-l1-tx-size",
		Usage: "Maximum size in bytes of any L1 transaction that gets " +
			"generated by the proposer",
		Required: true,
		EnvVar:   prefixEnvVar("MAX_PROPOSER_L1_TX_SIZE"),
	}
...
var requiredFlags = []cli.Flag{
	...
	CTCAddressFlag,
	SCCAddressFlag,
	MinSequencerL1TxSizeFlag,
	MaxSequencerL1TxSizeFlag,
	MinProposerL1TxSizeFlag,
	MaxProposerL1TxSizeFlag,
