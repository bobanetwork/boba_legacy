...
module.exports.relayerAddress = process.env.RELAYER_ADDRESS
module.exports.sequencerAddress = process.env.SEQUENCER_ADDRESS
module.exports.proposerAddress = process.env.PROPOSER_ADDRESS
module.exports.fastRelayerAddress = process.env.FAST_RELAYER_ADDRESS
