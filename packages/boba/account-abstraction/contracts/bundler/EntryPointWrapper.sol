...
contract EntryPointWrapper {
    ...
    function simulateValidation(UserOperation calldata userOp) external returns (ReturnInfo memory, StakeInfo memory, StakeInfo memory, StakeInfo memory, AggregatorStakeInfo memory) {
        try entryPoint.simulateValidation(userOp) {}
            ...
            if (receivedSelector == ValidationResult.selector) {
                ...
                return (returnInfo, senderInfo, factoryInfo, paymasterInfo, emptyAggregatorInfo);
