  ...
  describe('integration tests', () => {
    ...
    it('should get Boba and l1 native token prices', async () => {
      ...
      const BobaPriceFromCoinGecko =
        await tempGasPriceOracleService._getTokenPriceFromCoinGecko(
          'boba-network'
        )
      const l1NativeTokenPriceFromCoinGecko =
        await tempGasPriceOracleService._getTokenPriceFromCoinGecko(
          tempGasPriceOracleService.options.l1TokenCoinGeckoId
        )
      const BobaPriceFromCoinMarketCap =
        await tempGasPriceOracleService._getTokenPriceFromCoinMarketCap('14556')
      const l1NativeTokenPriceFromCoinMarketCap =
        await tempGasPriceOracleService._getTokenPriceFromCoinMarketCap(
          tempGasPriceOracleService.options.l1TokenCoinMarketCapId
        )
      /* eslint-enable */
