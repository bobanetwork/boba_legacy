        ...
        <BanxaContainer>
            ...
            <SwapContainer>
                <Label>
                    ...
                    <Row>
                        <Input placeholder="00.0" value={value} onChange={(handleInputChange)}/>
                        <Dropdown options={[{label:'USD', value:'usd'}, {label:'AUD', value:'aud'}]}/>
                        <Row>
                            USD
                        </Row>
                    </Row>
            ...
            <Column>
                ...
                <OptionContainer>
                    <Option>
                        <div><img src={Banxa} />Banxa</div> <Fees>Receive approx. 0.03455 ETH <Check className="active"/></Fees> 
                    </Option>
                </OptionContainer>
                <ButtonContainer>
                    <Button
