...
function BobaBridge() {
  ...
  if (!accountEnabled && toL2) {
    return (
      <S.BobaBridgeWrapper>
        <Box sx={{ my: 1 }}>
          <Typography variant="h3" pb='12px'>Bridge</Typography>
        ...
        <S.BobaContent>
          <S.BobaContentWrapper flexDirection="column" fullWidth={true} gap="5px" alignItems="flex-start" my={1}>
            <Box width="100%" mb="38px">
              <Typography variant="body2" pb="10px" >From</Typography>
              <S.ChainInput>
                <S.ChainLabel component="p" variant="body"><L1Icon selected />{networkName[ 'l1' ] || DEFAULT_NETWORK.NAME.L1}</S.ChainLabel>
              </S.ChainInput>
            </Box>
            <S.IconSwitcher onClick={() => { switchDirection() }}>
              <svg transform="rotate(90)" width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Box width="100%">
              <Typography variant="body2" mt="10px" pb="10px">To</Typography>
              <S.ChainInput>
                <S.ChainLabel component="p" variant="body"><L2Icon selected />{networkName[ 'l2' ] || DEFAULT_NETWORK.NAME.L2}</S.ChainLabel>
              </S.ChainInput>
            </Box>
          </S.BobaContentWrapper>
          <Box alignSelf="flex-start">
            <Button sx={{ marginTop: '38px' }} onClick={() => { connectToETH() }} color='primary' variant='contained'>Connect</Button>
          </Box>
        </S.BobaContent>
      </S.BobaBridgeWrapper>
    )
    ...
    return (
      <S.BobaBridgeWrapper>
        ...
        <S.BobaContent>
          ...
          <Box alignSelf="flex-start">
            <Button sx={{ marginTop: '38px' }} onClick={() => { connectToBOBA() }} color='primary' variant='contained'>Connect</Button>
          </Box>
        </S.BobaContent>
      </S.BobaBridgeWrapper>
    )
    ...
    <>
      <S.BobaBridgeWrapper>
        <S.BobaContentWrapper flexDirection="row" fullWidth={true} gap="10px" alignItems="center">
          ...
          <Box display="flex" flexDirection="column" alignItems="center" mt="26px">
            <S.IconSwitcher onClick={() => { switchDirection() }}>
          ...
          <Box width="100%">
            <Typography variant="body2" pb="10px" >To</Typography>
            <S.ChainInput>
              {layer === 'L2' ?
                <S.ChainLabel component="p" variant="body"><L1Icon selected />{networkName[ 'l1' ] || DEFAULT_NETWORK.NAME.L1}</S.ChainLabel>
                :
