...
import { CHAIN_NAME, ChainMap, TRANSACTION_FILTER_STATUS } from './types'
...
export const FILTER_OPTIONS: IFilterDropdownItem[] = [
  { value: TRANSACTION_FILTER_STATUS.All, label: 'All Status' },
  { value: TRANSACTION_FILTER_STATUS.Completed, label: 'Completed' },
  { value: TRANSACTION_FILTER_STATUS.Pending, label: 'Pending' },
  { value: TRANSACTION_FILTER_STATUS.Canceled, label: 'Canceled' },
]
