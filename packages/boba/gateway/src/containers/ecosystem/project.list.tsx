...
export const projectList: Project[] = [
  {
    ...
    image: sushicom,
    description:
      'Decentralized Exchange Made For Everybody. Swap, earn, stack yields, lend, borrow, leverage all on one decentralized, community driven platform. Welcome home to DeFi.',
  },
  {
    title: 'OolongSwap',
    canLaunch: true,
  ...
  },
  {
    ...
    image: koyoLogo,
    description:
      'Kōyō is the first next-generation AMM protocol in the Boba ecosystem. It is inspired by Curve and Balancer. At its core it’s a decentralized exchange (DEX) that minimizes unnecessary losses from swaps between assets of equal value.',
  },
  {
    title: 'BoringDAO',
    canLaunch: true,
  ...
  },
  {
    ...
    description:
      'Cross-Chain Router Protocol, envisioned to be the ultimate router for Web3.',
  },
  {
    title: 'Synapse',
    canLaunch: true,
    ...
    image: synLogo,
    description:
      'A widely used cross-chain liquidity network connecting all blockchains.',
  },
  {
  ...
  },
  {
    ...
    image: hedgeyLogo,
    description:
      'DAOs are the future of human organization. We create financial infrastructure for DAO treasuries to help them diversify assets, alleviate contributor sell pressure, and prosper through DAO to DAO swaps.',
  },
  {
    title: 'Gin Finance',
    canLaunch: true,
  ...
  },
  {
    ...
    image: XDAOLogo,
    description:
      'A smart DAO tooling for crypto entrepreneurs. Currently supported by 25 blockchains.',
  },
  {
    title: 'WitNet',
    canLaunch: true,
  ...
  },
  {
    ...
    image: witnetLogo,
    description:
      'A trustless multi-chain oracle whose security is founded on strong cryptoeconomic incentives.',
  },
  {
    title: 'Boba Punks',
    canLaunch: false,
  ...
  },
  {
    ...
    image: pmc,
    description:
      'Memes wallet is a non-custodial multichain wallet with a memeable UI dedicated with funny features for meme coins fans it gives users control over their own private keys, addresses, and funds. ',
  },
  {
    title: 'ApeBoard',
    canLaunch: true,
  ...
  },
  {
    ...
    image: deBankLogo,
    description:
      'A leading DeFi portfolio tracker that supports a large number of DeFi protocols across 19 chains.',
  },
  {
    title: 'SafePal',
    canLaunch: false,
  ...
  },
  {
    ...
    image: dodoLogo,
    description:
      'Decentralized Trading Protocol for Web3, Powered by Proactive Market Making.',
  },
  {
    title: 'tofuNFT',
    canLaunch: true,
  ...
  },
  {
    ...
    image: bobaApesLogo,
    description:
      'Christmas collection of 10000 randomized and unique digital collectibles.',
  },
  {
    title: 'D’CENT Wallet',
    canLaunch: false,
  ...
  },
  {
    ...
    image: defiyieldLogo,
    description:
      'Manage Your DeFi Life. Asset Management Dashboard secured by a Blockchain Security Blockchain.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Buy, store, swap, spend cryptocurrency and interact with DApps all in one gate.',
  },
  {
    title: 'ONTO Wallet',
    canLaunch: false,
  ...
  },
  {
    ...
    description:
      'We aggregate all cross-chain routers, which allows us to provide our users with a vast selection of the most efficient routes for any‑to‑any token exchanging',
  },
  {
    title: 'Bridge Network',
    canLaunch: true,
    link: 'http://bridgenetwork.com/',
    telegram: 'http://t.me/BridgeNetwork0x',
    twitter: 'https://twitter.com/bridgenetwork0x',
    discord: 'http://discord.gg/PGHnWapB8u',
    type: 'bridge',
    image: bridgeNetworkLogo,
    description:
      'Move or integrate fungible and non-fungible across 10+ blockchains via a trustless network.',
  },
  {
    title: 'Futuructa',
    canLaunch: true,
    ...
    image: futuructaLogo,
    description:
      'Merge simple objects to get improved ones, solve puzzles and complete quests!',
  },
  {
    title: 'Rabby Wallet',
    canLaunch: true,
  ...
  },
  {
    ...
    image: nowwalletLogo,
    description:
      'NOW Wallet is a fast, secure and non-custodial crypto wallet developed by the team of ChangeNOW Crypto Exchange service',
  },
  {
    title: 'ChangeNOW',
    canLaunch: true,
    ...
    image: changenowLogo,
    description:
      'Non-custodial service created for simple and fast cryptocurrency exchanges: buy and swap BOBA.',
  },
  {
    title: 'NOWPayments',
    canLaunch: true,
    ...
    description:
      'NOWPayments is a non-custodial crypto payment gateway that lets you accept payments in 160+ cryptocurrencies, including BOBA, with auto coin conversion available.',
  },
  {
    title: 'BlockVision',
    canLaunch: true,
    ...
    description:
      'BlockVision is a one-stop development platform and on-chain data retrieval portal for developers that boasts impressively low-latencies and high availability.',
  },
  {
    ...
    description:
      'Bundlr is building the future of data storage by bringing the speed and ease of web2 to web3 technology. We are a decentralized storage scaling platform, powered by Arweave.',
  },
  {
    title: 'Babylons',
    canLaunch: true,
    ...
    image: babylons,
    description:
      'Babylons NFT Marketplace and web3.0 Infrastructure Services. Babylons is an ecosystem governed by a unique DAO model serving as a community-governed NFT Platform, a premiere blockchain gaming aggregator, a cutting-edge launchpad and web3.0 technology solutions provider trusted by over 200 partners.',
  },
  {
    ...
    description:
      'Foxtrot Command is a fast and extremely competitive trading card game with new mechanics and the innovative double lane system. Compete against other players and upgrade your deck to reach the top of the leaderboard',
  },
  {
    title: 'FoxWallet',
    canLaunch: true,
    ...
    image: foxwalletLogo,
    description:
      'Multi-chain decentralized mobile wallet, dedicated to creating an entrance and connection to the Web3 world.',
  },
  {
    title: 'GhostNColors',
    canLaunch: true,
  ...
  },
  {
    ...
    description:
      'Mint your .boba domains as NFT assets that will bind the domain to your wallet address. You can also set records for your website, email, twitter, description and even your own avatar.',
  },
]
...
export const loadProjectByCategory = () => {
  ...
  const orderProjects: { [key: string]: Project[] } = {}
