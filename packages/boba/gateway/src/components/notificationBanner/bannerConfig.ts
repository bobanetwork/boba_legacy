...
export const BannerConfig: Record<string, BannerContent> = {
  ...
  [NETWORK.FANTOM]: {
    message: `BobaOpera is being wound down & will no longer be available soon, `,
    content: `BobaOpera is being wound down & will no longer be available soon, For users of BobaOpera or BobaOpera applications you will need to transfer all your funds to Fantom mainnet as earliest possible or risk permanently losing access to any assets on BobaOpera.`,
  },
}
