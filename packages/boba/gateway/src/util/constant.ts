...
export const POLL_INTERVAL:EnvType = process.env.REACT_APP_POLL_INTERVAL || 20000
export const GAS_POLL_INTERVAL:EnvType = process.env.REACT_APP_GAS_POLL_INTERVAL || 40000
export const GA4_MEASUREMENT_ID:EnvType = process.env.REACT_APP_GA4_MEASUREMENT_ID || null
...
export const MAX_HEALTH_BLOCK_LAG:EnvType = process.env.REACT_APP_MAX_HEALTH_BLOCK_LAG
...
// WalletConnect FLAG
export const DISABLE_WALLETCONNECT:EnvType = process.env.REACT_APP_DISABLE_WALLETCONNECT
...
export const ECOSYSTEM_CATEGORY: string[] = [ 'defi', 'gamefi', 'nft', 'bridge', 'wallet', 'tool', 'token' ];
...
type Page = 'Bridge' | 'Ecosystem' | 'Wallet' | 'History' | 'Earn' | 'Stake' | 'DAO' | 'Monster';
...
export const MM_EXTENTION_URL:string = 'https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn?hl=en'
