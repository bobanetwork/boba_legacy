...
export const RINKEBY_L2_NAME= process.env.REACT_APP_RINKEBY_L2_NAME
export const RINKEBY_L2_CHAIN_ID= process.env.REACT_APP_RINKEBY_L2_CHAIN_ID
export const RINKEBY_L2_CHAIN_ID_HEX= process.env.REACT_APP_RINKEBY_L2_CHAIN_ID_HEX
export const RINKEBY_L2_RPC_URL= process.env.REACT_APP_RINKEBY_L2_RPC_URL
