...
NETWORKS = {
  rinkeby: {
    ...
    addressBOBAUrl:   `https://rinkeby.boba.network:8078/addresses.json`,
    BOBA_WATCHER_URL: `https://api-watcher.rinkeby.boba.network/`,
    MM_Label:         `Rinkeby`,
    L1: {
      name: "Rinkeby",
      chainId: 4,
  ...
  mainnet: {
    ...
    addressBOBAUrl:   `https://mainnet.boba.network:8078/addresses.json`,
    BOBA_WATCHER_URL: `https://api-watcher.mainnet.boba.network/`,
    MM_Label:         `Mainnet`,
    L1: {
      name: "Mainnet",
      chainId: 1,
...
if (env === 'dev') {
  NETWORKS = {
    local: {
      ...
      addressBOBAUrl:   `http://${window.location.hostname}:8078/addresses.json`,
      BOBA_WATCHER_URL: null, //Does not exist on local
      MM_Label:         `Local`,
      L1: {
        name: "Local L1",
        chainId: 31337,
    ...
    rinkeby_integration: {
      ...
      addressBOBAUrl:   `https://rinkeby-integration.boba.network:8081/boba-addr.json`,
      BOBA_WATCHER_URL: `https://api-watcher.rinkeby-integration.boba.network/`,
