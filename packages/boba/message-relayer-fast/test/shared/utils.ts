...
if (!process.env.L1_NODE_WEB3_URL) {
  ...
  console.log(
    `process.env.L1_NODE_WEB3_URL set to:`,
    process.env.L1_NODE_WEB3_URL
  )
}

export const L1_NODE_WEB3_URL =
...
if (!process.env.L2_NODE_WEB3_URL) {
  ...
  console.log(
    `process.env.L2_NODE_WEB3_URL set to:`,
    process.env.L2_NODE_WEB3_URL
  )
}

export const L2_NODE_WEB3_URL =
  process.env.L2_NODE_WEB3_URL || 'http://localhost:8545'
...
export const katel1Wallet = new Wallet(process.env.TEST_PRIVATE_KEY_3).connect(
  l1Provider
)
export const katel2Wallet = new Wallet(process.env.TEST_PRIVATE_KEY_3).connect(
  l2Provider
)
...
export const Proxy__L2CrossDomainMessenger =
  '0x4200000000000000000000000000000000000007'

export const DEPLOYER =
  process.env.URL || 'http://127.0.0.1:8080/addresses.json'
...
export const getAddressManager = async (provider: any) => {
  ...
  if (addressManagerAddress) {
    ...
    console.log(
      `ADDRESS_MANAGER_ADDRESS var was left unset. Using {$DEPLOYER} response`
    )
