...
const deployFn: DeployFunction = async (hre) => {
    ...
    console.log(`🌕 ${chalk.red('L1MultiMessageRelayerFast deployed to:')} ${chalk.green(L1_MultiMessageRelayerFast.address)}`)
    ...
    console.log(`⭐️ ${chalk.blue('L1MultiMessageRelayerFast registered:')} ${chalk.green(L1MMRFastTXreg.hash)}`)
    ...
    console.log(`⭐️ ${chalk.blue('L2BatchFastMessageRelayer Address registered:')} ${chalk.green(FastBatchRelayerTXreg.hash)}`)
}
