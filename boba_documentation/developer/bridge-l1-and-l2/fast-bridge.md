...
The Fast Bridge is composed of two main contracts called the [`L1LiquidityPool`](https://github.com/bobanetwork/boba/blob/develop/packages/boba/contracts/contracts/LP/L1LiquidityPool.sol)and  [`L2LiquidityPool` ](https://github.com/bobanetwork/boba/blob/develop/packages/boba/contracts/contracts/LP/L2LiquidityPool.sol) for **Ethereum L2**. The modified  [`L1LiquidityPoolAltL1`](https://github.com/bobanetwork/boba/blob/develop/packages/boba/contracts/contracts/LP/L1LiquidityPoolAltL1.sol)and the [`L2LiquidityPoolAltL1` ](https://github.com/bobanetwork/boba/blob/develop/packages/boba/contracts/contracts/LP/L2LiquidityPoolAltL1.sol) are for **Alt L2s (Avalanche, BNB, Moonbeam and Fantom)**.
...
| Network   | URL                                                          |
| --------- | ------------------------------------------------------------ |
| Ethereum  | [Ethereum Boba Token List](../token-addresses.md#Ethereum <> BOBA L2) |
