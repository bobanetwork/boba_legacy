...
3. **Total cost** is calculated as `tx.gasPrice * (l2GasUsed + l1GasPrice * l1GasUsed / tx.gasPrice)`. The L2 gas Used is higher than l1, because we add the **L1 security fee**.
